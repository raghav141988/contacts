...
cd $TRAVIS_BUILD_DIR/contacts-external-api-gateway
docker build -t raghav141988/contacts-external-api-gateway:latest -t raghav141988/contacts-external-api-gateway:$BUILD_ID -f ./Dockerfile .
cd $TRAVIS_BUILD_DIR
ls -l
echo $PWD
...
docker push raghav141988/contacts-external-api-gateway:latest
...
docker push raghav141988/contacts-external-api-gateway:$BUILD_ID
...
kubectl set image deployments/contact-backend-api-deployment contacts-backend-api=raghav141988/contacts-external-api-gateway:$BUILD_ID
